...
var easyQuestionList = [
    ...
    },
    {
        ...
        answer: "Чертов Мост", status: false, answered: false, difficulty: 1, anMaterials: [['Иллюстрация', '7.jpg']]
    },
    {
    ...
    },
    {
        id: 9, question: "Эта страна помнит русского полководца и его \"чудо-богатырей\".В июне 1999 года в торжественной обстановке был" +
            " открыт памятник нашему герою, созданный скульптором Д.Н. Тугариновым. Назовите эту страну?", answer: "Швейцария",
        status: false, answered: false, difficulty: 1
    },
    {
    ...
    { id: 29, question: "Каким образом А. Розенбергу удалось ввести Массену в заблуждение, и тем самым, обеспечить себе трое суток бесприпятственного соединения с армией А. Суворова?", answer: "Приказ населению Швица о заготовке провианта на 2-е суток, тем самым он отвел внимание армии Массена к Швицу, который принялся организовывать оборону Цюриха", status: false, answered: false, difficulty: 3 },
